...
\begin{center}
  \begin{tabular}[h]{cll}
    ...
    (5) & \textit{Wir haben mal wieder keine Ahnung, \uline{warum das so lange dauert}.} & \Solalt{\Square(\XBox)}{\Square} \\
...
\Sol{Hinweis zu (5): \textit{warum} ist im Nebensatz syntaktisch nicht von einem Komplementierer zu unterscheiden. Man behandelt es aber gemeinhin als eine Art von Adverb, weil es wie viele andere ähnliche Adverben wie \textit{woher}, \textit{wozu} usw.\ auch im unabhängigen Satz in Vorfeldposition stehen kann. Hier würde ich beides gelten lassen, aber an sich ist es schlicht und einfach nicht nötig, für solche Wörter eine zweite Existenz als Komplementierer anzunehmen. Funktional passt auch eine Einstufung als Adverb besser.}
