...
Entscheiden Sie für die unterstrichenen Konstituenten in den unten stehenden Sätzen, ob sie ein sogenanntes Satzprädikat, eine Prädikativergänzung bei einer Kopula, eine Pseudo-Prädikativergänzung bei Verben wie \textit{halten für} oder ein Resultativprädikat darstellen.
...
\begin{center}
  \begin{longtable}{cl}
    ...
    & \Square~Satzprädikat\ \ \ \Square~Prädikativergänzung\ \ \ \Solcross~Pseudo-Präd.erg.\ \ \ \Square~Resultativprädikat \\
    &\\
    (2) & \textit{Das wird \ul{nichts}.} \\
    & \Square~Satzprädikat\ \ \ \Solcross~Prädikativergänzung\ \ \ \Square~Pseudo-Präd.erg.\ \ \ \Square~Resultativprädikat \\
    &\\
    (3) & \textit{Petra \ul{hat} den Rasen \ul{mähen wollen}.} \\
    & \Solcross~Satzprädikat\ \ \ \Square~Prädikativergänzung\ \ \ \Square~Pseudo-Präd.erg.\ \ \ \Square~Resultativprädikat \\
    &\\
    ...
    & \Square~Satzprädikat\ \ \ \Square~Prädikativergänzung\ \ \ \Square~Pseudo-Präd.erg.\ \ \ \Solcross~Resultativprädikat \\
    &\\
