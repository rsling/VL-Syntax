...
\begin{quote}
  Das Lehramt im Fach Deutsch ist besonders schwierig, weil \Solalt{[es neben fundiertem Wissen verschiedenste Kompetenzen erfordert]}{es neben fundiertem Wissen verschiedenste Kompetenzen erfordert}.
  Lehrpersonen sollten von vornherein wissen, dass \Solalt{[sie sich ein überaus anspruchsvolles Fach ausgesucht haben]}{sie sich ein überaus anspruchsvolles Fach ausgesucht haben}.
  Obwohl \Solalt{[im Studium eigentlich keine Zeit dafür ist]}{im Studium eigentlich keine Zeit dafür ist}, sollten zum Beispiel weitreichende Fähigkeiten in grammatischer Analyse erworben werden.
  ...
  Es wäre aus Sicht der Linguistik durchaus denkbar, andere Studieninhalte zu reduzieren, damit \Solalt{[Studierende nach dem Studium mit der nötigen Souveränität in den Deutschunterricht gehen können]}{Studierende nach dem Studium mit der nötigen Souveränität in den Deutschunterricht gehen können}.
\end{quote}
