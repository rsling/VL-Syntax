...
\begin{frame}
  ...
  \centering
  \onslide<+->
  \rot{[Dieses] durch \textit{Reflexion über Sprache} [\ldots] [geforderte besondere Verhältnis zur Sprache] können die Schüler nicht entwickeln, wenn es die Lehrer nicht haben.} \grau{\citep[23]{Eisenberg2004}}
\end{frame}
...
\begin{frame}
  ...
  \onslide<+->
  \onslide<+->
  \includegraphics[height=0.\textheight]{graphics/kasusschule1}\\
...
\begin{frame}
  ...
  \onslide<+->
  \Zeile
  \rot{Erklären Sie, wie das zustande kommt, wie es richtig heißt,\\
